    ...
    return <div>
        ...
        <div className={mergeStyles({ display: "flex", flexDirection: "row" })}>
            ...
            <div className={mergeStyles({ width: "50%", padding: "0 20px" })}>
                <SubscriptionDetails subscription={selectedSubcription} subscriptionResources={subscriptionResources} subscriptionResourcesLoading={subscriptionResourcesLoading} />
            </div>
        </div>
    </div>
};
