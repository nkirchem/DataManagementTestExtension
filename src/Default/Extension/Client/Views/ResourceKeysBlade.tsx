...
export class ResourceKeysBlade {
     ...
     */
    public readonly title = ClientResources.resourceKeyBladeTitle;

    /**
     * The subtitle of Resource Keys blade
     */
    public readonly subtitle = ClientResources.resourceKeyBladeSubtitle;
    ...
    private _initializeSection(): void {
        ...
        this._primaryKeyCopyableViewModel = CopyableLabel.create(container, {
            ...
            readOnly: true,
            value: "1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121-1800-3456-0988888821-212121212121",
        });
    ...
    private _initializeCommandBar(): void {
        const { container } = this.context;
        const primaryKeyButton = Toolbar.ToolbarItems.createBasicButton(container, {
            label: ClientResources.keyPrimaryKeyLabel,
            icon: Images.Redo(),
            onClick: () => {
                this._primaryKeyCopyableViewModel.value("212121212121-1800-3456-0988888821");
            },
        });

        const secondaryKeyButton = Toolbar.ToolbarItems.createBasicButton(container, {
            label: ClientResources.keySecondaryKeyLabel,
            icon: Images.Redo(),
            onClick: () => {
                this._secondaryKeyCopyableViewModel.value("89586473479-20320-21546-3230923020932");
            },
        });

        const commandBar = Toolbar.create(container, { items: [primaryKeyButton, secondaryKeyButton] });
